				...
				<div class="row">
					<div class="col-sm-12">
							...
							<div class="row">
                                ...
                                <div class="col-sm-3">
									...
									<div class="ribbon-wrapper">
										<div class="ribbon sale">i luv you</div>
									</div>
									@endif
						...
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">Tim thay {{count($top_product)}} san pham</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
                                @foreach ($top_product as $spkm)
                                    <div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="/product_detail"><img src="source/image/product/{{$spkm->image}}" alt=""></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{$spkm->name}}</p>
											<p class="single-item-price" style="font-size: 18px;">
												<span class="flash-del">{{number_format($spkm->unit_price)}} dong</span>
												<span class="flash-sale">{{number_format($spkm->unit_price)}} dong</span>
											</p>
										</div>
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
								...
								{{-- <div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="/product_detail"><img src="source/assets/dest/images/products/2.jpg" alt=""></a>
										</div>
										<div class="single-item-body">
								...
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="/product_detail"><img src="source/assets/dest/images/products/3.jpg" alt=""></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">Sample Woman Top</p>
											<p class="single-item-price">
